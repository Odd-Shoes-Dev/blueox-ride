...
import { authRepository } from '@/shared/services/database'
...
import { Camera, Star, Car, LogOut, Moon, Sun } from 'lucide-react'
...
export default function ProfilePage() {
  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      publicUrl = await authRepository.uploadAvatar(profile.id, file)
    } catch (uploadError) {
      toast({
        title: 'Upload failed',
