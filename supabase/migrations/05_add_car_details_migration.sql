-- Step 05 of 6 — Add Car Details to Rides Migration
-- Run this in Supabase Dashboard -> SQL Editor (after 04_car_photos_migration.sql,
-- since this recreates the rides_with_driver view introduced there)
